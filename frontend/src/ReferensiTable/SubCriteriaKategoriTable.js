...
import CLabel from "../../coreui-react-master/src/form/CLabel"
  ...
  const SubCritKategori = (props) => {
    ...
    const addAlter = (array) => {
      axios.post(`http://localhost:8086/api/subcritcategory`, array).then((res) => {
        toggle();
      });
    };
    ...
    const checkData = async () => {
      axios.get(`http://localhost:8086/api/subcritcategory/`).then((res) => {
      ...
      <div className="animated fadeIn">
        <CCard>
          <CCardHeader>
            ...
            <h2 className="text-center">Tabel Sub Kriteria Kategori</h2>
            <br />
  ...
  export default SubCritKategori;

...
import CLabel from "../../coreui-react-master/src/form/CLabel"
  ...
  const SubCritHarga = (props) => {
    ...
    const addAlter = (array) => {
      axios.post(`http://localhost:8086/api/subcritprice`, array).then((res) => {
        toggle();
      });
    };
    ...
    const checkData = async () => {
      axios.get(`http://localhost:8086/api/subcritprice/`).then((res) => {
      ...
      <div className="animated fadeIn">
        <CCard>
          <CCardHeader>
            ...
            <h2 className="text-center">Tabel Sub Kriteria Harga</h2>
            <br />
